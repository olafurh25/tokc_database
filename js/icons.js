...
export const ICONS = Object.fromEntries([
  ...
  iconEntry("book"),
  iconEntry("coins"),
  iconEntry("clans", "icon--faction"),
  iconEntry("uprising", "icon--faction"),
  iconEntry("gathering", "icon--faction"),
  iconEntry("nobility", "icon--faction"),
  iconEntry("hq"),
  iconEntry("kingdom"),
  iconEntry("favour"),
  ...
  iconEntry("resilient", "icon--trait"),
  iconEntry("invulnerable", "icon--trait"),
  iconEntry("pathfinder", "icon--trait"),
  iconEntry("cost", "icon--stat"),
  iconEntry("votes", "icon--stat"),
  iconEntry("lore", "icon--stat"),
  iconEntry("influence"),
  iconEntry("sim"),
]);
